var HtmlControlJS = 
{
    ...
    writeDocument: function(doc, content, lcid, build)
    {
        ...
        doc.writeln('<link type="text/css" rel="stylesheet" href="/_layouts/15/' + lcid + '/wh/stylesV2/masterroot.css?b='+ build +'" />');
        doc.writeln('<link type="text/css" rel="stylesheet" href="../resources/theme-2.css" />'); // This file is not cached, so no versioning
